        ...
        try {
            ...
            if($e->errorInfo[1] == 1062) {
                ...
                <script>
                    ...
                    validText.innerText = "Account with this username or email already exists.";
                </script>
                ';
    ...
    <body  onload="setRanAuthBg()">
        <div id="page">
            <div class="form-container">
                ...
                <form method="post" onsubmit="return validateForm();" name="reg">
        ...
        <script>
            function validateForm() {
                let colorNum = document.forms['reg']['favDmc'].value;
                const validText = document.getElementById('form-validation');
